 ...
 */
function formatName($title, $preferredName, $surname, $roleCategory, $reverse = false, $informal = false, $username = '') //GS
{
    return Format::name($title, $preferredName, $surname, $roleCategory, false, $informal, $username); //GS
}
