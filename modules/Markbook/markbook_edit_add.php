    ...
    if ($highestAction == false) {
        ...
        if ($gibbonCourseClassID == '') {
            ...
            if ($result->rowCount() != 1) {
                ...
                //GS//    $units = $row->addSelect('gibbonUnitID')->fromQuery($pdo, $sql, $data)->placeholder()->selected($gibbonUnitID);
                ...
                //GS//    $row->addSelect('gibbonPlannerEntryID')->fromQueryChained($pdo, $sql, $data, 'gibbonUnitID')->placeholder()->selected($gibbonPlannerEntryID);
                ...
                //GS//    $row->addTextField('//GS//')->required()->maxLength(1000)->setValue($summary);
                ...
                $row = $form->addRow();
                    ...
                    $row->addYesNoRadio('comment')->checked('N')->required(); //GS//

                $row = $form->addRow();
                    $row->addLabel('uploadedResponse', __('Include Uploaded Response?'));
                    $row->addYesNoRadio('uploadedResponse')->checked('N')->required(); //GS//
