...
if (isActionAccessible($guid, $connection2, '/modules/Staff/absences_add.php') == false) {
    ...
    //GS//$row = $form->addRow();
    //GS//    $row->addLabel('allDay', __('When'));
    //GS//    $row->addCheckbox('allDay')
    //GS//        ->description(__('All Day'))
    //GS//        ->inline()
    //GS//        ->setClass()
    //GS//        ->setValue('Y')
    //GS//        ->checked('Y')
    //GS//        ->wrap('<div class="standardWidth floatRight">', '</div>');

    $form->addHiddenValue('allDay', 'Y'); //GS//

    //GS//$form->toggleVisibilityByClass('timeOptions')->onCheckbox('allDay')->whenNot('Y');
    //GS//$form->toggleVisibilityByClass('timeOptions')->onCheckbox('allDay')->whenNot('Y');

    //GS//$row = $form->addRow()->addClass('timeOptions');
    //GS//    $row->addLabel('timeStart', __('Time'));
    //GS//    $col = $row->addColumn('timeStart')->addClass('right inline');
    //GS//    $col->addTime('timeStart')
    //GS//        ->setClass('shortWidth')
    //GS//        ->isRequired();
    //GS//    $col->addTime('timeEnd')
    //GS//        ->chainedTo('timeStart')
    //GS//        ->setClass('shortWidth')
    //GS//        ->isRequired();

    $form->addHiddenValue('timeStart', ''); //GS//
    $form->addHiddenValue('timeEnd', ''); //GS//
...
//GS// */
    $form->addHiddenValue('notificationList', '');
    $form->addHiddenValue('comment', '');
