                ...
                if ($result->rowCount() != 1) {
                    ...
                    if (($row['role'] == 'Student' and $row['viewableStudents'] == 'N') and ($highestAction == 'Lesson Planner_viewMyChildrensClasses' and $row['viewableParents'] == 'N')) {
                        ...
                        if ($row['role'] == 'Teacher') {
                            ...
                            echo "<input type='hidden' name='confidentialPlan' class='confidentialPlan' value='Yes' />"; //GS//
                            //GS//echo "<span title='".__('Includes student data & teacher\'s notes')."' style='font-size: 85%; font-weight: normal; font-style: italic'> ".__('Show Confidential Data').'</span>';
                            echo '</td>';
                            echo '</tr>';
                            echo '</div>';
                        } else {
