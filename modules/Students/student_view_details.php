        ...
        if (empty($gibbonPersonID)) {
            ...
            if (isActionAccessible($guid, $connection2, '/modules/Students/student_view_details.php', 'View Student Profile_brief') and $skipBrief == false) {
                        ...
                        if ($resultFamily->rowCount() < 1) {
                            ...
                            while ($rowFamily = $resultFamily->fetch()) {
                                ...
                                while ($rowMember = $resultMember->fetch()) {
                                    ...
                                    echo '</td>';
                                    //GS//echo "<td style='width: 33%; padding-top: 15px; width: 34%; vertical-align: top' colspan=2>";
                                    ...
                                    //GS//        echo "<a href='mailto:".$rowMember['email']."'>".$rowMember['email'].'</a><br/>';
                                    //GS//    }
                                    //GS//    echo '<br/>';
                                    //GS//}
                                    //GS//echo '</td>';
                ...
                if ($result->rowCount() != 1) {
                    ...
                    $sections = array($subpage); //GS//

                    if ($allinone AND ($subpage == '' OR $subpage == 'Overview' OR $subpage == 'Personal' OR $subpage == 'Family' OR $subpage == 'Emergency Contacts' OR $subpage == 'Medical')) { //GS//
                        $sections = array('Overview', 'Family', 'Emergency Contacts', 'Medical'); //GS//
                    } //GS//

                    foreach ($sections as $section) //GS//
                    { //GS//
                        $subpage = $section; //GS//
                        ...
                        if ($subpage == 'Overview') {
                            ...
                            echo '<tr>';
                            echo "<td style='width: 33%; vertical-align: top'>";
                            echo "<span style='font-size: 115%; font-weight: bold'>".__('Name').'</span><br/>'; //GS//
                            echo Format::name('', $row['preferredName'], $row['surname'], 'Student');
                            echo '</td>';
                            echo "<td style='width: 34%; vertical-align: top'>";
                            echo "<span style='font-size: 115%; font-weight: bold'>".__('Gender').'</span><br/>'; //GS//
                            echo ($row['gender'] == 'M' ? 'Male' : ($row['gender'] == 'F' ? 'Female' : $row['gender'])); //GS//
                            echo '</td>';
                            echo "<td style='width: 34%; vertical-align: top'>";
                            ...
                            //GS//try {
                            //GS//    $dataDetail = array('gibbonYearGroupID' => $row['gibbonYearGroupID']);
                            //GS//    $sqlDetail = "SELECT DISTINCT gibbonPersonID, title, surname, preferredName FROM gibbonPerson JOIN gibbonYearGroup ON (gibbonYearGroup.gibbonPersonIDHOY=gibbonPersonID) WHERE status='Full' AND gibbonYearGroupID=:gibbonYearGroupID";
                            //GS//    $resultDetail = $connection2->prepare($sqlDetail);
                            //GS//    $resultDetail->execute($dataDetail);
                            //GS//} catch (PDOException $e) {
                            //GS//    echo "<div class='error'>".$e->getMessage().'</div>';
                            //GS//}
                            //GS//if ($resultDetail->rowCount() == 1) {
                            //GS//    echo "<span style='font-size: 115%; font-weight: bold;'>".__('Head of Year').'</span><br/>';
                            //GS//    $rowDetail = $resultDetail->fetch();
                            //GS//    if (isActionAccessible($guid, $connection2, '/modules/Staff/staff_view_details.php')) {
                            //GS//        echo "<a href='".$_SESSION[$guid]['absoluteURL'].'/index.php?q=/modules/Staff/staff_view_details.php&gibbonPersonID='.$rowDetail['gibbonPersonID']."'>".Format::name('', $rowDetail['preferredName'], $rowDetail['surname'], 'Staff', false, true).'</a>';
                            //GS//    } else {
                            //GS//        echo Format::name($rowDetail['title'], $rowDetail['preferredName'], $rowDetail['surname'], 'Staff');
                            //GS//    }
                            //GS//    echo '<br/>';
                            //GS//}
                            //GS//echo '</td>';
                            ...
                            //GS//echo '<tr>';
                            //GS//echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                            //GS//echo "<span style='font-size: 115%; font-weight: bold'>".__('Locker Number').'</span><br/>';
                            //GS//if ($row['lockerNumber'] != '') {
                            //GS//    echo $row['lockerNumber'];
                            //GS//}
                            //GS//echo '</td>';
                            //GS//echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                            ...
                            //GS//echo '<tr>';
                            //GS//echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                            //GS//echo "<span style='font-size: 115%; font-weight: bold'>".__('Preferred Name').'</span><br/>';
                            //GS//echo Format::name('', $row['preferredName'], $row['surname'], 'Student');
                            //GS//echo '</td>';
                            //GS//echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                            ...
                            //GS//echo '</td>';
                            //GS//echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                            //GS//echo "<span style='font-size: 115%; font-weight: bold'>".__('Name In Characters').'</span><br/>';
                            //GS//echo $row['nameInCharacters'];
                            //GS//echo '</td>';
                            //GS//echo '</tr>';
                            echo '<tr>';
                            echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                            ...
                            echo '</td>';
                            echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                            //GS//echo "<span style='font-size: 115%; font-weight: bold'>".__('Alternate Email').'</span><br/>';
                            //GS//if ($row['emailAlternate'] != '') {
                            //GS//    echo "<i><a href='mailto:".$row['emailAlternate']."'>".$row['emailAlternate'].'</a></i>';
                            //GS//}
                            echo '</td>';
                            ...
                            echo '</td>';
                            //GS//echo "<td style='width: 33%; vertical-align: top'>";
                            //GS//echo "<span style='font-size: 115%; font-weight: bold'>".__('Ethnicity').'</span><br/>';
                            //GS//echo $row['ethnicity'];
                            //GS//echo '</td>';
                            echo "<td style='width: 34%; vertical-align: top'>";
                            ...
                            //GS//echo '<tr>';
                            //GS//echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                            //GS//echo "<span style='font-size: 115%; font-weight: bold'>".__('Citizenship 1').'</span><br/>';
                            //GS//if ($row['citizenship1'] != '')
                            //GS//    echo $row['citizenship1']."<br/>";
                            //GS//if ($row['citizenship1Passport'] != '')
                            //GS//    echo $row['citizenship1Passport']."<br/>";
                            //GS//if ($row['citizenship1PassportScan'] != '')
                            //GS//    echo "<a target='_blank' href='".$_SESSION[$guid]['absoluteURL'].'/'.$row['citizenship1PassportScan']."'>View Passport</a>";
                            //GS//echo '</td>';
                            //GS//echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                            //GS//echo "<span style='font-size: 115%; font-weight: bold'>".__('Citizenship 2').'</span><br/>';
                            //GS//echo $row['citizenship2'];
                            //GS//if ($row['citizenship2Passport'] != '') {
                            //GS//    echo '<br/>';
                            //GS//    echo $row['citizenship2Passport'];
                            //GS//}
                            //GS//echo '</td>';
                            echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                            ...
                            echo '<tr>';
                            //GS//echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                            //GS//echo "<span style='font-size: 115%; font-weight: bold'>".__('First Language').'</span><br/>';
                            //GS//echo $row['languageFirst'];
                            //GS//echo '</td>';
                            //GS//echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                            //GS//echo "<span style='font-size: 115%; font-weight: bold'>".__('Second Language').'</span><br/>';
                            //GS//echo $row['languageSecond'];
                            //GS//echo '</td>';
                            //GS//echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                            //GS//echo "<span style='font-size: 115%; font-weight: bold'>".__('Third Language').'</span><br/>';
                            //GS//echo $row['languageThird'];
                            //GS//echo '</td>';
                            //GS//echo '</tr>';
                            //GS//echo '<tr>';
                            //GS//echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                            //GS//if ($_SESSION[$guid]['country'] == '') {
                            //GS//    echo "<span style='font-size: 115%; font-weight: bold'>".__('Residency/Visa Type').'</span><br/>';
                            //GS//} else {
                            //GS//    echo "<span style='font-size: 115%; font-weight: bold'>".$_SESSION[$guid]['country'].' '.__('Residency/Visa Type').'</span><br/>';
                            //GS//}
                            //GS//echo $row['residencyStatus'];
                            //GS//echo '</td>';
                            //GS//echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                            //GS//if ($_SESSION[$guid]['country'] == '') {
                            //GS//    echo "<span style='font-size: 115%; font-weight: bold'>".__('Visa Expiry Date').'</span><br/>';
                            //GS//} else {
                            //GS//    echo "<span style='font-size: 115%; font-weight: bold'>".$_SESSION[$guid]['country'].' '.__('Visa Expiry Date').'</span><br/>';
                            //GS//}
                            //GS//if ($row['visaExpiryDate'] != '') {
                            //GS//    echo dateConvertBack($guid, $row['visaExpiryDate']);
                            //GS//}
                            //GS//echo '</td>';
                            //GS//echo "<td style='width: 33%; padding-top: 15px; vertical-align: top'>";
                            ...
                            echo '</td>';
                            //GS//echo '<tr>';
                            //GS//echo "<td style='padding-top: 15px ; vertical-align: top'>";
                            //GS//echo "<span style='font-size: 115%; font-weight: bold'>".__('House').'</span><br/>';
                            //GS//try {
                            //GS//    $dataDetail = array('gibbonHouseID' => $row['gibbonHouseID']);
                            //GS//    $sqlDetail = 'SELECT * FROM gibbonHouse WHERE gibbonHouseID=:gibbonHouseID';
                            ...
                            //GS//echo $row['studentID'];
                            //GS//echo '</td>';
                            //GS//echo "<td style='width: 34%; vertical-align: top'>";
                            //GS//try {
                            //GS//    $dataDetail = array('gibbonYearGroupID' => $row['gibbonYearGroupID']);
                            //GS//    $sqlDetail = "SELECT DISTINCT gibbonPersonID, title, surname, preferredName FROM gibbonPerson JOIN gibbonYearGroup ON (gibbonYearGroup.gibbonPersonIDHOY=gibbonPersonID) WHERE status='Full' AND gibbonYearGroupID=:gibbonYearGroupID";
                            //GS//    $resultDetail = $connection2->prepare($sqlDetail);
                            ...
                            //GS//echo '<h4>';
                            //GS//echo __('System Data');
                            //GS//echo '</h4>';

                            //GS//echo "<table class='smallIntBorder' cellspacing='0' style='width: 100%'>";
                            //GS//echo '<tr>';
                            //GS//echo "<td width: 33%; style='vertical-align: top'>";
                            //GS//echo "<span style='font-size: 115%; font-weight: bold'>".__('Username').'</span><br/>';
                            //GS//echo $row['username'];
                            //GS//echo '</td>';
                            //GS//echo "<td style='width: 33%; vertical-align: top'>";
                            //GS//echo "<span style='font-size: 115%; font-weight: bold'>".__('Can Login?').'</span><br/>';
                            //GS//echo ynExpander($guid, $row['canLogin']);
                            //GS//echo '</td>';
                            //GS//echo "<td style='width: 34%; vertical-align: top'>";
                            //GS//echo "<span style='font-size: 115%; font-weight: bold'>".__('Last IP Address').'</span><br/>';
                            //GS//echo $row['lastIPAddress'];
                            //GS//echo '</td>';
                            //GS//echo '</tr>';
                            //GS//echo '</table>';

                            //GS//echo '<h4>';
                            //GS//echo __('Miscellaneous');
                            //GS//echo '</h4>';

                            //GS//echo "<table class='smallIntBorder' cellspacing='0' style='width: 100%'>";
                            //GS//echo '<tr>';
                            //GS//echo "<td style='width: 33%; vertical-align: top'>";
                            //GS//echo "<span style='font-size: 115%; font-weight: bold'>".__('Transport').'</span><br/>';
                            //GS//echo $row['transport'];
                            //GS//if ($row['transportNotes'] != '') {
                            //GS//    echo '<br/>';
                            //GS//    echo $row['transportNotes'];
                            //GS//}
                            //GS//echo '</td>';
                            //GS//echo "<td style='width: 33%; vertical-align: top'>";
                            //GS//echo "<span style='font-size: 115%; font-weight: bold'>".__('Vehicle Registration').'</span><br/>';
                            //GS//echo $row['vehicleRegistration'];
                            //GS//echo '</td>';
                            //GS//echo "<td style='width: 33%; vertical-align: top'>";
                            //GS//echo "<span style='font-size: 115%; font-weight: bold'>".__('Locker Number').'</span><br/>';
                            //GS//echo $row['lockerNumber'];
