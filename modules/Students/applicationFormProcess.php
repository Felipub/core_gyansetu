...
//GS//ini_set('display_errors',1);
//GS//error_reporting(E_ALL);
...
if ($proceed == false) {
    ...
    if (is_null($id)) {
        ...
        $firstName = trim($_POST['preferredName']); //GS//
        $preferredName = trim($_POST['preferredName']);
        $officialName = $preferredName.' '.$surname; //GS//
        ...
        $gibbonRollGroupID = $_POST['gibbonRollGroupID']; //GS//
        ...
        if ($gibbonFamily == 'TRUE') {
            ...
            if (/*$parent1title == '' or $parent1surname == '' or $parent1firstName == '' or */$parent1preferredName == '' or /*$parent1officialName == '' or*/ $parent1gender == '' or $parent1relationship == ''/*  or $parent1phone1 == '' or $parent1profession == ''*/) { //GS//
                    $familyFail = true;
                    //GS//die('$parent1surname '.$parent1surname.' $parent1firstName '.$parent1firstName. ' $parent1preferredName ' .$parent1preferredName.' $parent1officialName '.$officialName.' $gender '.$gender.' $dob '.$dob. '$parent1relationship '.$parent1relationship.' $familyFail '.$familyFail);
                }
            }
            if (isset($_POST['secondParent'])) {
                if ($_POST['secondParent'] != 'No') {
                    if (/*$parent2title == '' or $parent2surname == '' or $parent2firstName == '' or */$parent2preferredName == '' or /*$parent2officialName == '' or*/ $parent2gender == '' or $parent2relationship == ''/* or $parent2phone1 == '' or $parent2profession == ''*/) { //GS//
                        $familyFail = true;
                    }
                }
            }
        }
        if (/*$surname == '' or $firstName == '' or*/ $preferredName == '' or /*$officialName == '' or */$gender == '' or /*$dob == '' or $languageHomePrimary == '' or $languageFirst == '' or $countryOfBirth == '' or $citizenship1 == '' or*/ $gibbonSchoolYearIDEntry == '' or $dateStart == '' or $gibbonYearGroupIDEntry == '' or $sen == '' or $howDidYouHear == '' or (isset($_POST['agreement']) and $agreement != 'Y') or $familyFail) { //GS//
            $URL .= '&return=error1';
            //GS//die('$surname '.$surname.' $firstName '.$firstName. ' $preferredName ' .$preferredName.' $officialName '.$officialName.' $gender '.$gender.' $dob '.$dob.' $gibbonSchoolYearIDEntry '.$gibbonSchoolYearIDEntry.' $dateStart '.$dateStart.' $gibbonYearGroupIDEntry '.$gibbonYearGroupIDEntry.' $sen '.$sen.' $howDidYouHear '.$howDidYouHear.' $familyFail '.$familyFail);
            header("Location: {$URL}");
        } else {
