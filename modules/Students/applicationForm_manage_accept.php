    ...
    if ($gibbonApplicationFormID == '' or $gibbonSchoolYearID == '') {
        ...
        if ($result->rowCount() != 1) {
            ...
            if ($step == 1) {
                ...
                //GS//$informStudent = (getSettingByScope($connection2, 'Application Form', 'notificationStudentDefault') == 'Y');
                //GS//$col->addCheckbox('informStudent')
                //GS//    ->description(__('Automatically inform <u>student</u> of Gibbon login details by email?'))
                //GS//    ->inline(true)
                //GS//    ->checked($informStudent)
                //GS//    ->setClass('');

                //GS//$informParents = (getSettingByScope($connection2, 'Application Form', 'notificationParentsDefault') == 'Y');
                //GS//$col->addCheckbox('informParents')
                //GS//    ->description(__('Automatically inform <u>parents</u> of their Gibbon login details by email?'))
                //GS//    ->inline(true)
                //GS//    ->checked($informParents)
                //GS//    ->setClass('');
                ...
                if ($failStudent == true) {
                    ...
                    if (!empty($values['gibbonFamilyID']) || !empty($linkedApplication['gibbonFamilyID'])) {
                        ...
                        if ($failFamily == true) {
                            ...
                            if ($values['parent1gibbonPersonID'] != '') {
                                ...
                                if ($lock == true) {
                                    ...
                                    if ($gotAI == true) {
                                        ...
                                        $username = 'G1-'.$gibbonPersonID; //GS//

                                        // Generate a random password
                                        $password = 'DISABLED'; //GS//
                                        $salt = getSalt();
                                        $passwordStrong = 'DISABLED'; //GS//
                                        ...
                                        if ($continueLoop == false) {
                                            $insertOK = true;
                                            try {
                                                $data = array('username' => ($username == NULL ? '' : $username),
                                                'title' => ($values['parent1title'] == NULL ? '' : $values['parent1title']),
                                                'surname' => ($values['parent1surname'] == NULL ? '' : $values['parent1surname']),
                                                'preferredName' => ($values['parent1preferredName'] == NULL ? '' : $values['parent1preferredName']),
                                                'gender' => ($values['parent1gender'] == NULL ? '' : $values['parent1gender']),
                                                'parent1languageFirst' => ($values['parent1languageFirst'] == NULL ? '' : $values['parent1languageFirst']),
                                                'nationalIDCardNumber' => ($values['parent1nationalIDCardNumber'] == NULL ? '' : $values['parent1nationalIDCardNumber']),
                                                'email' => ($values['parent1email'] == NULL ? '' : $values['parent1email']),
                                                'phone1Type' => ($values['parent1phone1Type'] == NULL ? '' : $values['parent1phone1Type']),
                                                'phone1CountryCode' => ($values['parent1phone1CountryCode'] == NULL ? '' : $values['parent1phone1CountryCode']),
                                                'phone1' => ($values['parent1phone1'] == NULL ? '' : $values['parent1phone1']),
                                                'phone2Type' => ($values['parent1phone2Type'] == NULL ? '' : $values['parent1phone2Type']),
                                                'phone2CountryCode' => ($values['parent1phone2CountryCode'] == NULL ? '' : $values['parent1phone2CountryCode']),
                                                'phone2' => ($values['parent1phone2'] == NULL ? '' : $values['parent1phone2']),
                                                'profession' => ($values['parent1profession'] == NULL ? '' : $values['parent1profession']),
                                                'employer' => ($values['parent1employer'] == NULL ? '' : $values['parent1employer']),
                                                'parent1fields' => ($values['parent1fields'] == NULL ? '' : $values['parent1fields'])); //GS//
                                                $sql = "INSERT INTO gibbonPerson SET username=:username, gibbonRoleIDPrimary='004', gibbonRoleIDAll='004', status='Full', title=:title, surname=:surname, preferredName=:preferredName, firstName=:preferredName, gender=:gender, languageFirst=:parent1languageFirst, nationalIDCardNumber=:nationalIDCardNumber, email=:email, phone1Type=:phone1Type, phone1CountryCode=:phone1CountryCode, phone1=:phone1, phone2Type=:phone2Type, phone2CountryCode=:phone2CountryCode, phone2=:phone2, profession=:profession, employer=:employer, fields=:parent1fields"; //GS//
                                                $result = $connection2->prepare($sql);
                                                $result->execute($data);
                                            } catch (PDOException $e) {
                                                $result->debugDumpParams(); //GS//
                                                var_dump($data); //GS//
                                                $insertOK = false;
                                                echo "<div class='error'>".$e->getMessage().'</div>';
                                            }
                            ...
                            //CREATE PARENT 2
                            if ($values['parent2preferredName'] != '' /*and $values['parent2surname'] != ''*/) { //GS//
                                $failParent2 = true;
                                $lock = true;
                                try {
                                    $sql = 'LOCK TABLES gibbonPerson WRITE, gibbonUsernameFormat WRITE, gibbonRole WRITE';
                                ...
                                if ($lock == true) {
                                    ...
                                    if ($gotAI == true) {
                                        ...
                                        if ($continueLoop == false) {
                                            ...
                                            try {
                                              $data = array('username' => ($username == NULL ? '' : $username),
                                              'title' => ($values['parent2title'] == NULL ? '' : $values['parent2title']),
                                              'surname' => ($values['parent2surname'] == NULL ? '' : $values['parent2surname']),
                                              'preferredName' => ($values['parent2preferredName'] == NULL ? '' : $values['parent2preferredName']),
                                              'gender' => ($values['parent2gender'] == NULL ? '' : $values['parent2gender']),
                                              'parent2languageFirst' => ($values['parent2languageFirst'] == NULL ? '' : $values['parent2languageFirst']),
                                              'nationalIDCardNumber' => ($values['parent2nationalIDCardNumber'] == NULL ? '' : $values['parent2nationalIDCardNumber']),
                                              'email' => ($values['parent2email'] == NULL ? '' : $values['parent2email']),
                                              'phone1Type' => ($values['parent2phone1Type'] == NULL ? '' : $values['parent2phone1Type']),
                                              'phone1CountryCode' => ($values['parent2phone1CountryCode'] == NULL ? '' : $values['parent2phone1CountryCode']),
                                              'phone1' => ($values['parent2phone1'] == NULL ? '' : $values['parent2phone1']),
                                              'phone2Type' => ($values['parent2phone2Type'] == NULL ? '' : $values['parent2phone2Type']),
                                              'phone2CountryCode' => ($values['parent2phone2CountryCode'] == NULL ? '' : $values['parent2phone2CountryCode']),
                                              'phone2' => ($values['parent2phone2'] == NULL ? '' : $values['parent2phone2']),
                                              'profession' => ($values['parent2profession'] == NULL ? '' : $values['parent2profession']),
                                              'employer' => ($values['parent2employer'] == NULL ? '' : $values['parent2employer']),
                                              'parent2fields' => ($values['parent2fields'] == NULL ? '' : $values['parent2fields'])); //GS//
                                              $sql = "INSERT INTO gibbonPerson SET username=:username, gibbonRoleIDPrimary='004', gibbonRoleIDAll='004', status='Full', title=:title, surname=:surname, preferredName=:preferredName, firstName=:preferredName, gender=:gender, languageFirst=:parent2languageFirst, nationalIDCardNumber=:nationalIDCardNumber, email=:email, phone1Type=:phone1Type, phone1CountryCode=:phone1CountryCode, phone1=:phone1, phone2Type=:phone2Type, phone2CountryCode=:phone2CountryCode, phone2=:phone2, profession=:profession, employer=:employer, fields=:parent2fields"; //GS//
                                                $result = $connection2->prepare($sql);
                                                $result->execute($data);
                                            } catch (PDOException $e) {
                                                $insertOK = false;
