        ...
        if ($result->rowCount() != 1) {
            ...
            if ($gibbonFamily == 'TRUE') {
                ...
                if (/*$parent1title == '' or $parent1surname == '' or $parent1firstName == '' or */$parent1preferredName == '' or /*$parent1officialName == '' or*/ $parent1gender == '' or $parent1relationship == ''/* or $parent1phone1 == '' or $parent1profession == ''*/) { //GS//
                        //GS//die("parent1preferredName ".$parent1preferredName." parent1gender ".$parent1gender." parent1relationship ".$parent1relationship); //GS//
                        $familyFail = true;
                    }
                }
            }
            if (/*$priority == '' or $surname == '' or $firstName == '' or */$preferredName == '' or /*$officialName == '' or*( $gender == '' or /*$dob == '' or $languageHomePrimary == '' or $languageFirst == '' or*/ $gibbonSchoolYearIDEntry == '' or $dateStart == '' or $gibbonYearGroupIDEntry == '' or /*$sen == '' or $howDidYouHear == '' or*/ $familyFail) { //GS//
                //GS//die(" priority ".$priority." firstName ".$firstName." preferredName ".$preferredName." gender ".$gender." dob ".$dob." gibbonSchoolYearIDEntry ".$gibbonSchoolYearIDEntry." dateStart ".$dateStart." gibbonYearGroupIDEntry ".$gibbonYearGroupIDEntry." howDidYouHear ".$howDidYouHear." familyFail ".$familyFail); //GS//
                $URL .= '&return=error3';
                header("Location: {$URL}");
            } else {
